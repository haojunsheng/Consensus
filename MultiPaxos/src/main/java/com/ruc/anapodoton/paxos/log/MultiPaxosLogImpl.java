package com.ruc.anapodoton.paxos.log;
...
import com.ruc.anapodoton.paxos.utils.MmapTool;

public class MultiPaxosLogImpl implements MultiPaxosLog {
	...
	public MultiPaxosLogImpl(Accepter accepter) throws IOException {
		// TODO Auto-generated constructor stub
		this.accepter = accepter;
		this.tool = new MmapTool(getLogFileAddr());
	}
	
	public MultiPaxosLogImpl(String addr) throws IOException {
		// TODO Auto-generated constructor stub
	...
	public static void main(String[] args) {
		try {
			MultiPaxosLog multiPaxosLog = new MultiPaxosLogImpl("./dataDir/test.log");
			//multiPaxosLog.setInstanceAcceptedBallot(1, 1);
			//multiPaxosLog.setInstanceBallot(1, 3);
			multiPaxosLog.setInstanceValue(1, "hello");
			multiPaxosLog.setInstanceValue(2, "paxos");
			multiPaxosLog.setInstanceBallot(3, 1);
			multiPaxosLog.setInstanceAcceptedBallot(4, 2);
			multiPaxosLog.recoverFromLog();
			multiPaxosLog.clearLog();
			multiPaxosLog.setInstanceValue(1, "hello");
			multiPaxosLog.setInstanceValue(2, "paxos");
			multiPaxosLog.recoverFromLog();
		} catch (IOException e) {
